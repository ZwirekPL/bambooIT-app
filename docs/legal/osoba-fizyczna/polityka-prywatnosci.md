...
ul. Pod Brzozami 16/8a, 03-995 Warszawa
...
| **Google Ireland Limited** | Dublin, Irlandia (EU) | Analityka ruchu w serwisie (Google Analytics 4) — tylko po wyrażeniu zgody w banerze cookies | Przetwarzanie w EOG; SCC dla transferów do Google LLC (USA); anonimizacja IP |
...
- **Google LLC** — analityka ruchu (Google Analytics 4, na podstawie zgody użytkownika; dane przesyłane przez Google Ireland Limited z siedzibą w EOG).
