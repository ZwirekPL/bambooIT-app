...
**Wersja:** 1.0
**Data wejścia w życie:** [DATA] r.
**Administrator serwisu:** [NAZWA FIRMY], [FORMA PRAWNA], z siedzibą w [MIASTO], adres: [ADRES], wpisana do rejestru przedsiębiorców Krajowego Rejestru Sądowego prowadzonego przez Sąd Rejonowy [SĄD], [WYDZIAŁ] Wydział Gospodarczy KRS, pod numerem KRS: [NR KRS], NIP: [NIP], REGON: [REGON], kapitał zakładowy: [KAPITAŁ] PLN
**Osoba kontaktowa:** [IMIĘ NAZWISKO]
**Adres e-mail kontaktowy:** [EMAIL KONTAKTOWY]
