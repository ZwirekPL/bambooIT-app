...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    ...bilingualEntry('/strony-internetowe',         'monthly', 0.8),
    ...bilingualEntry('/aplikacje',                  'monthly', 0.8),
    ...bilingualEntry('/automatyzacje',              'monthly', 0.8),
    ...bilingualEntry('/branze',                     'monthly', 0.6),
