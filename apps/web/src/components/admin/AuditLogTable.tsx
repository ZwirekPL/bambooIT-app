...
const ACTION_GROUPS: Array<{ label: string; actions: string[] }> = [
  ...
  { label: 'Pacjenci', actions: ['VIEW_PATIENT', 'UPDATE_PATIENT', 'DELETE_PATIENT', 'CREATE_INTERVIEW', 'VIEW_INTERVIEW', 'CREATE_CHECKIN', 'CHECKIN_ADAPTATION', 'REQUEST_MEAL_SWAP', 'CONFIRM_MEAL_SWAP'] },
